...
const SearchBoxBig = () => {
    return (
        <div className="searchbox-big">
            <div className="container-location" onClick={() => {
                ...
                <input type="text" className="input-location" placeholder="Stay Place"></input>
            </div>
            <div className="container-guests" onClick={() => {
                let  guestContainer = document.querySelector(".container-guests");
            ...
            <button className="btn-search-big"><FaSearch className="icon"/>Search</button>
        </div>
    )
}
